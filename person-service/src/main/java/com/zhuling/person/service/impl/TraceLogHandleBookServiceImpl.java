...
@Service("traceLogHandleBookService")
@Slf4j
public class TraceLogHandleBookServiceImpl implements TraceLogHandleService {

    @Override
    public TraceLog buildTraceLog(GdsBaseRequest gdsBaseRequest, GdsBaseResponse gdsBaseResponse) {
        log.info("traceLogHandleBookService execute");
